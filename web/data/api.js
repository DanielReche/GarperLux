...
window.GarperLuxApi = (() => {
  ...
  return {
    ...
    guestCheckout: (payload) => request('/orders/guest-checkout', { method: 'POST', body: JSON.stringify(payload) }),
    ...
    publicOrder: (code, email = '') => request(`/public/orders/${encodeURIComponent(code)}?email=${encodeURIComponent(email)}`),
