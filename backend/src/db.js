...
function seedDemoAccountData(db) {
  ...
  if (antonio) {
    ...
    if (!hasRequests) {
      ...
      seedRequest({
        code: 'GLX-2026-04-2748', status: 'reviewing', service_type: 'Avería eléctrica', urgency: 'urgent',
        address: 'Calle Real 12, Mengíbar (Jaén)', description: 'Salta el automático al enchufar el microondas.',
        payload: { category: 'electricidad', contactPhone: '600111222' }, created_at: '2026-04-26 18:42:00',
        events: [
      ...
      seedRequest({
        code: 'GLX-2026-03-2104', status: 'resolved', service_type: 'Cambio de magnetotérmico defectuoso', urgency: 'normal',
        address: 'Calle Real 12, Mengíbar (Jaén)', description: 'Magnetotérmico de cocina con disparo intermitente.',
        payload: { category: 'protecciones', technician: 'Alfonso T.', invoiceTotal: 125.4 }, created_at: '2026-03-15 10:10:00',
        events: [
      ...
      seedRequest({
        code: 'GLX-2026-02-1487', status: 'resolved', service_type: 'Instalación de videoportero Wi-Fi', urgency: 'normal',
        address: 'Calle Real 12, Mengíbar (Jaén)', description: 'Instalación de videoportero Shelly con conexión Wi-Fi.',
        payload: { category: 'domotica', technician: 'Pedro R.', invoiceTotal: 298.0 }, created_at: '2026-02-18 11:00:00',
        events: [
      ...
      seedRequest({
        code: 'GLX-2026-01-0892', status: 'cancelled', service_type: 'Revisión preventiva anual', urgency: 'normal',
        address: 'Calle Real 12, Mengíbar (Jaén)', description: 'Revisión preventiva del cuadro eléctrico.',
        payload: { category: 'mantenimiento' }, created_at: '2026-01-10 09:00:00',
        events: [
  ...
  const ORDERS = [
    {
      ...
      lines: [['27101-31', 8], ['A9F74225', 5], ['LED-A60-9W-2700K', 12], ['PRY-MNG3-1.5', 50]],
      eventsExtra: [
    ...
    },
    {
      ...
      paymentMethod: { id: 'transfer', label: 'Transferencia · 30 días', type: 'bank_transfer' },
      lines: [['LEG-401222', 1], ['A9F74225', 4], ['SCH-A9R60240', 2], ['27101-31', 12], ['27201-31', 6], ['27431-31', 8], ['75101-39', 14], ['PRY-MNG3-1.5', 80]],
      eventsExtra: [
